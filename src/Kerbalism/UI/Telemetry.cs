	...
	public static class Telemetry
	{
		...
		static void Render_environment(Panel p, Vessel v, VesselData vd)
		{
			...
			if (vd.SolarPanelsAverageExposure >= 0.0)
			{
				...
				p.AddContent(Local.TELEMETRY_SolarPanelsAverageExposure, exposureString, Local.TELEMETRY_SolarPanelsAverageExposure_desc);//"solar panels average exposure""Realtime/low-speed background: current panel exposure\nHigh-warp analytic: full-period modeled power versus unobscured ideal-alignment maximum"
			}
