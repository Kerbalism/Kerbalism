...
namespace KERBALISM
{
	...
	public static class Local
	{
		...
		public static ParamString Comfort_spin_metrics = new ParamString("Comfort_spin_metrics"); // "<<1>> g @ <<2>> rpm"
		...
		public static string SpinFirmGround_desc = GetLoc("SpinFirmGround_desc"); // "Grant firm ground when the whole vessel spins with enough artificial gravity"
		public static string SpinMinArtificialG = GetLoc("SpinMinArtificialG"); // "Minimum Spin Gravity"
		public static string SpinMinArtificialG_desc = GetLoc("SpinMinArtificialG_desc"); // "Minimum artificial gravity in g at every occupied crew part"
		...
		public static string Planner_spin_worst_radius = GetLoc("Planner_spin_worst_radius"); // "worst crew radius"
