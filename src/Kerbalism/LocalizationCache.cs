...
namespace KERBALISM
{
	...
	public static class Local
	{
		...
		// Note also that a lot of the fields here are actually unused, because the strings are used in KSP partmodules attributes.
		// Those strings can be added here as comments, they don't need to be static fields created with GetLoc
		// (this whole mess was regex-autogenerated, I missed that particular case)

		// set this to true (and change the paths in the GenerateLocTemplatemethod) to generate a template
		public static bool GenerateLocalizationTemplate = false;

		// set the bool english to true to generate the en-us loaclization, or to false to generate a template for other languages
		public static void GenerateLocTemplate(bool english = false)
		{
			...
			System.IO.File.WriteAllLines(@"C:\Users\Got\Desktop\loctest\loctemplate.txt", locFile.ToArray());
		}
