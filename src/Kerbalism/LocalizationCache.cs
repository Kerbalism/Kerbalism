...
namespace KERBALISM
{
	...
	public static class Local
	{
		...
		public static string Generic_Years = GetLoc("Generic_Years"); // "y"
		public static string Generic_Days = GetLoc("Generic_Days"); // "d"
		public static string Generic_Hours = GetLoc("Generic_Hours"); // "h"
		public static string Generic_Minutes = GetLoc("Generic_Minutes"); // "m"
		public static string Generic_Seconds = GetLoc("Generic_Seconds"); // "s"
		...
		public static string Contracts_orbitTitle = GetLoc("Contracts_orbitTitle"); // "Keep a crewed vessel in orbit for 30 days"
		public static string Contracts_orbitDesc = GetLoc("Contracts_orbitDesc"); // "Obtaining an orbit was easier than we expected. Now it is time to keep a crewed vessel in orbit for 30 days."
		public static string Contracts_orbitComplete = GetLoc("Contracts_orbitComplete"); // "The mission was a success, albeit the crew is a bit bored. We have plenty of data about long-term permanence in space."
		public static string Contracts_foodTitle = GetLoc("Contracts_foodTitle"); // "Produce food in space"
		public static string Contracts_foodDesc = GetLoc("Contracts_foodDesc"); // "Now that we got the technology to grow food in space, we should probably test it. Produce food from a greenhouse in space."
		public static string Contracts_foodComplete = GetLoc("Contracts_foodComplete"); // "We produced food in space, and our scientists says it is actually delicious."
		...
		public static string Comfort_spin = GetLoc("Comfort_spin"); // "vessel spin"
		public static string Comfort_spin_na = GetLoc("Comfort_spin_na"); // "n/a"
		public static ParamString Comfort_spin_metrics = new ParamString("Comfort_spin_metrics"); // "<<1>>/<<2>> seats @ <<3>> rpm"
		...
		public static string TELEMETRY_SolarPanelsAverageExposure_desc = GetLoc("TELEMETRY_SolarPanelsAverageExposure_desc"); // "Flux-weighted captured solar power versus unobscured per-star ideal response\nRealtime/low-speed: current; high-warp: full-period average"
		...
		public static string Trait_Pilot = GetLoc("Trait_Pilot"); // "Pilot"
		public static string Trait_Engineer = GetLoc("Trait_Engineer"); // "Engineer"
		public static string Trait_Scientist = GetLoc("Trait_Scientist"); // "Scientist"
		...
		public static ParamString Module_Configure_techAt = new ParamString("Module_Configure_techAt"); // "at <<1>>"
		public static string Module_Configurable = GetLoc("Module_Configurable"); // "Configurable"
		public static string Module_Emitter = GetLoc("Module_Emitter"); // "Emitter"
		...
		public static string Module_Sensor = GetLoc("Module_Sensor"); // "Sensor"
		public static string Module_GravityRing = GetLoc("Module_GravityRing"); // "Gravity Ring"
		...
		public static string Greenhouse_producing = GetLoc("Greenhouse_producing"); // "producing"
		...
		public static string Greenhouse_issue4 = GetLoc("Greenhouse_issue4"); // "waiting for storage"
		public static string Greenhouse_info1 = GetLoc("Greenhouse_info1"); // "Food rate"
		...
		public static string Reliability_MessagePost27 = GetLoc("Reliability_MessagePost27"); // "It can still be repaired, but requires greater expertise"
		...
		public static ParamString Reliability_MessagePost30 = new ParamString("Reliability_MessagePost30"); // "<<1>> needs a repair kit"
		public static string Reliability_MessagePost31 = GetLoc("Reliability_MessagePost31"); // "Did I forget something."
		public static string Reliability_MessagePost32 = GetLoc("Reliability_MessagePost32"); // "Oh crap..."
		...
		public static string Preferences_Section3 = GetLoc("Preferences_Section3"); // "Kerbalism (3)"
		...
		public static string PartMalfunctions_desc = GetLoc("PartMalfunctions_desc"); // "Allow part failures based on part age and mean time between failures (MTBF)"
		public static string CriticalFailureRate = GetLoc("CriticalFailureRate"); // "Critical Failure Chance"
		public static string CriticalFailureRate_desc = GetLoc("CriticalFailureRate_desc"); // "Chance that a breakdown becomes a critical (red) failure instead of a normal (yellow) malfunction"
		public static string FixableFailureRate = GetLoc("FixableFailureRate"); // "Unmanned Safe Mode"
		public static string FixableFailureRate_desc = GetLoc("FixableFailureRate_desc"); // "On unmanned vessels, chance that a malfunction is automatically cleared instead of breaking the part. Has no effect on crewed vessels."
		public static string IncentiveRedundancy = GetLoc("IncentiveRedundancy"); // "Redundancy Bonus"
		public static string IncentiveRedundancy_desc = GetLoc("IncentiveRedundancy_desc"); // "When a part malfunctions, other parts in the same redundancy group get increased MTBF"
		...
		public static string SpinFirmGround = GetLoc("SpinFirmGround"); // "Vessel Spin Firm Ground"
		public static string SpinFirmGround_desc = GetLoc("SpinFirmGround_desc"); // "Grant firm ground when enough crew seats meet the artificial-gravity threshold while the vessel spins"
		public static string SpinMinArtificialG = GetLoc("SpinMinArtificialG"); // "Minimum Spin Gravity"
		public static string SpinMinArtificialG_desc = GetLoc("SpinMinArtificialG_desc"); // "Minimum artificial gravity in g for a seat to count toward firm ground"
		public static string SpinMaxRpm = GetLoc("SpinMaxRpm"); // "Maximum Spin Rate"
		public static string SpinMaxRpm_desc = GetLoc("SpinMaxRpm_desc"); // "Maximum vessel spin rate in RPM (limits Coriolis discomfort)"
		public static string SpinCrewCoverage = GetLoc("SpinCrewCoverage"); // "Spin Seat Coverage"
		public static string SpinCrewCoverage_desc = GetLoc("SpinCrewCoverage_desc"); // "Fraction of aboard crew that must have a qualifying high-g seat"
		...
		public static string Planner_shadowtime_desc = GetLoc("Planner_shadowtime_desc"); // "estimated time in darkness\nat the selected altitude\n(half a rotation period when landed)"
		...
		public static string Planner_fullcharge = GetLoc("Planner_fullcharge"); // "full charge"
		public static string Planner_fullcharge_desc = GetLoc("Planner_fullcharge_desc"); // "time to fill batteries from empty\nat current net production"
		public static string Planner_vesselorbitalt = GetLoc("Planner_vesselorbitalt"); // "vessel orbit alt."
		public static string Planner_vesselorbitalt_desc = GetLoc("Planner_vesselorbitalt_desc"); // "altitude above the body\nleft: +\nright: -\nshift: ×10"
		public static string Planner_Custom = GetLoc("Planner_Custom"); // "Custom"
		...
		public static string Planner_spin_unavailable = GetLoc("Planner_spin_unavailable"); // "Spin estimate unavailable for this ship."
		public static string Planner_spin_nocrewparts = GetLoc("Planner_spin_nocrewparts"); // "No crewable parts found.\nFirm ground from vessel spin needs seats away from the spin axis."
		public static string Planner_spin_tip_intro = GetLoc("Planner_spin_tip_intro"); // "Estimate assuming spin about the best root-part axis,\nat the configured maximum RPM:"
		public static string Planner_spin_seats = GetLoc("Planner_spin_seats"); // "qualifying seats"
		public static string Planner_spin_marginal_radius = GetLoc("Planner_spin_marginal_radius"); // "innermost qualifying radius"
		public static string Planner_spin_gee_at_max = GetLoc("Planner_spin_gee_at_max"); // "gravity at max RPM"
		public static string Planner_spin_rpm_needed = GetLoc("Planner_spin_rpm_needed"); // "RPM needed for target"
		public static string Planner_spin_thresholds = GetLoc("Planner_spin_thresholds"); // "thresholds"
		...
		public static string Planner_repair_safemode = GetLoc("Planner_repair_safemode"); // "safemode"
