...
There is also a LocalHelpers class that is used to auto-generate the localization configs based on the contents of the Local class
...
namespace KERBALISM
{
	public static class LocalHelpers
	{
		...
		public static void GenerateLoc(bool template = false)
		{
			...
			foreach (string line in localCachelines)
			{
				if (!classFound)
				{
					if (line.Contains("public static class Local")) classFound = true;
					continue;
				}
		...
		public static void RegenerateNonEnglishLoc()
		{
			...
			foreach (string line in existingLocLines)
			{
				...
				if (locMatch.Success)
				{
					...
					{
						foreignLocs.Add(locMatch.Groups[1].Value, locMatch.Groups[2].Value);
					}
				}
			}
	...
	public static class Local
	{
		...
		////////////////////////////////////////////////////////////////////
		// START OF LOCALIZATION FIELDS (everything above this is garbage)
		////////////////////////////////////////////////////////////////////
