...
namespace KERBALISM
{
	...
	public static class Local
	{
		...
		//lib
		public static string none = GetLoc("none"); // "none"
		public static string perpetual = GetLoc("perpetual"); // "perpetual"
		public static string never = GetLoc("never"); // "never"
		public static string nominal = GetLoc("nominal"); // "nominal"
		public static string noslots = GetLoc("noslots"); // "no "
		...
		public static string TimeoutMsg2 = GetLoc("TimeoutMsg2"); // "Connection timed-out"
																  // #KERBALISM_TimeoutMsg3 // "New tentative in <<1>>//in <<1>>(s)"
		...
		//Moudule--Configure
		public static string Moudule_Configure = GetLoc("Moudule_Configure"); // "Configure"
		public static string Moudule_Configure_Slots = GetLoc("Moudule_Configure_Slots"); // "Slots"
		public static string Moudule_Configure_Reconfigure = GetLoc("Moudule_Configure_Reconfigure"); // "Reconfigure"
		public static string Moudule_Configure_Setups = GetLoc("Moudule_Configure_Setups"); // "Setups:"
		public static string Moudule_Configurable = GetLoc("Moudule_Configurable"); // "Configurable"
		public static string Moudule_Resources = GetLoc("Moudule_Resources"); // "Resources"
		public static string Moudule_Extra = GetLoc("Moudule_Extra"); // "Extra"
		public static string Moudule_mass = GetLoc("Moudule_mass"); // "mass"
		public static string Moudule_cost = GetLoc("Moudule_cost"); // "cost"

		//Moudule--Comfort
		public static string Moudule_Comfort = GetLoc("Moudule_Comfort"); // "Comfort"
		public static string Moudule_Comfort_Summary1 = GetLoc("Moudule_Comfort_Summary1"); // "ideal"
		public static string Moudule_Comfort_Summary2 = GetLoc("Moudule_Comfort_Summary2"); // "good"
		public static string Moudule_Comfort_Summary3 = GetLoc("Moudule_Comfort_Summary3"); // "modest"
		public static string Moudule_Comfort_Summary4 = GetLoc("Moudule_Comfort_Summary4"); // "poor"
		public static string Moudule_Comfort_Summary5 = GetLoc("Moudule_Comfort_Summary5"); // "none"

		//Moudule--Experiment
		public static string Moudule_Experiment_Prepare = GetLoc("Moudule_Experiment_Prepare"); // "Prepare"
		public static string Moudule_Experiment_Reset = GetLoc("Moudule_Experiment_Reset"); // "Reset"
		public static string Moudule_Experiment_issue_title = GetLoc("Moudule_Experiment_issue_title"); // "issue"
		public static string Moudule_Experiment_issue1 = GetLoc("Moudule_Experiment_issue1"); // "invalid situation"
		public static string Moudule_Experiment_issue2 = GetLoc("Moudule_Experiment_issue2"); // "shrouded"
		public static string Moudule_Experiment_issue3 = GetLoc("Moudule_Experiment_issue3"); // "reset required"
		public static string Moudule_Experiment_issue4 = GetLoc("Moudule_Experiment_issue4"); // "no Electricity"
		public static string Moudule_Experiment_issue5 = GetLoc("Moudule_Experiment_issue5"); // "crew on board"
		public static string Moudule_Experiment_issue6 = GetLoc("Moudule_Experiment_issue6"); // "depleted"
		public static string Moudule_Experiment_issue7 = GetLoc("Moudule_Experiment_issue7"); // "not prepared"
		public static string Moudule_Experiment_issue8 = GetLoc("Moudule_Experiment_issue8"); // "background flight"
		public static string Moudule_Experiment_issue9 = GetLoc("Moudule_Experiment_issue9"); // "unmet requirement"
		public static string Moudule_Experiment_issue10 = GetLoc("Moudule_Experiment_issue10"); // "missing resource"
		public static string Moudule_Experiment_issue11 = GetLoc("Moudule_Experiment_issue11"); // "no storage space"
																								// #KERBALISM_Moudule_Experiment_issue12 // "missing <<1>>                   //missing [Resource Name]"
		public static string Moudule_Experiment_runningstate1 = GetLoc("Moudule_Experiment_runningstate1"); // "stopped"
		public static string Moudule_Experiment_runningstate2 = GetLoc("Moudule_Experiment_runningstate2"); // "started"
		public static string Moudule_Experiment_runningstate3 = GetLoc("Moudule_Experiment_runningstate3"); // "forced run"
		public static string Moudule_Experiment_runningstate4 = GetLoc("Moudule_Experiment_runningstate4"); // "broken"
		public static string Moudule_Experiment_runningstate5 = GetLoc("Moudule_Experiment_runningstate5"); // "running"
		public static string Moudule_Experiment_runningstate6 = GetLoc("Moudule_Experiment_runningstate6"); // "waiting"
		public static string Moudule_Experiment_ScienceValuenone = GetLoc("Moudule_Experiment_ScienceValuenone"); // "none"
		public static string Moudule_Experiment_Requires = GetLoc("Moudule_Experiment_Requires"); // "Requires:"
		public static string Moudule_Experiment_Specifics_info1 = GetLoc("Moudule_Experiment_Specifics_info1"); // "Data size"
		public static string Moudule_Experiment_Specifics_info2 = GetLoc("Moudule_Experiment_Specifics_info2"); // "Data rate"
		public static string Moudule_Experiment_Specifics_info3 = GetLoc("Moudule_Experiment_Specifics_info3"); // "Duration"
		public static string Moudule_Experiment_Specifics_info4 = GetLoc("Moudule_Experiment_Specifics_info4"); // "Sample size"
		public static string Moudule_Experiment_Specifics_info5 = GetLoc("Moudule_Experiment_Specifics_info5"); // "Sample mass"
		public static string Moudule_Experiment_Specifics_info6 = GetLoc("Moudule_Experiment_Specifics_info6"); // "Samples"
		public static string Moudule_Experiment_Specifics_info7_sample = GetLoc("Moudule_Experiment_Specifics_info7_sample"); // "Duration"
		public static string Moudule_Experiment_Specifics_Situations = GetLoc("Moudule_Experiment_Specifics_Situations"); // "Situations:"
		public static string Moudule_Experiment_Specifics_info8 = GetLoc("Moudule_Experiment_Specifics_info8"); // "Needs:"
		public static string Moudule_Experiment_Specifics_info9 = GetLoc("Moudule_Experiment_Specifics_info9"); // "EC"
		public static string Moudule_Experiment_Specifics_info10 = GetLoc("Moudule_Experiment_Specifics_info10"); // "Preparation"
		public static string Moudule_Experiment_Specifics_info10_none = GetLoc("Moudule_Experiment_Specifics_info10_none"); // "none"
		public static string Moudule_Experiment_Specifics_info11 = GetLoc("Moudule_Experiment_Specifics_info11"); // "Operation"
		public static string Moudule_Experiment_Specifics_info11_unmanned = GetLoc("Moudule_Experiment_Specifics_info11_unmanned"); // "unmanned"
		public static string Moudule_Experiment_Specifics_info12 = GetLoc("Moudule_Experiment_Specifics_info12"); // "Reset"
		public static string Moudule_Experiment_Specifics_info12_none = GetLoc("Moudule_Experiment_Specifics_info12_none"); // "none"
		public static string Moudule_Experiment_MultipleRunsMessage_title = GetLoc("Moudule_Experiment_MultipleRunsMessage_title"); // "ALREADY RUNNING"
																																	// #KERBALISM_Moudule_Experiment_MultipleRunsMessage // "Can't start <<1>> a second time on vessel <<2>>"
		public static string Moudule_Experiment_Message1 = GetLoc("Moudule_Experiment_Message1"); // "I'm not qualified for this"
		public static string Moudule_Experiment_Message2 = GetLoc("Moudule_Experiment_Message2"); // "I will not even know where to start"
		public static string Moudule_Experiment_Message3 = GetLoc("Moudule_Experiment_Message3"); // "I'm afraid I can't do that"
		public static string Moudule_Experiment_Message4 = GetLoc("Moudule_Experiment_Message4"); // "Preparation Complete"
		public static string Moudule_Experiment_Message5 = GetLoc("Moudule_Experiment_Message5"); // "Ready to go"
		public static string Moudule_Experiment_Message6 = GetLoc("Moudule_Experiment_Message6"); // "Let's start doing some science!"
		public static string Moudule_Experiment_Message7 = GetLoc("Moudule_Experiment_Message7"); // "Reset Done"
		public static string Moudule_Experiment_Message8 = GetLoc("Moudule_Experiment_Message8"); // "It's good to go again"
		public static string Moudule_Experiment_Message9 = GetLoc("Moudule_Experiment_Message9"); // "Ready for the next bit of science"
		...
		public static string SolarPanelFixer_occludedbyterrain = GetLoc("SolarPanelFixer_occludedbyterrain"); // "occluded by terrain"
																											  // #KERBALISM_SolarPanelFixer_occludedby // "occluded by <<1>>                    //occluded by (xxx)"
