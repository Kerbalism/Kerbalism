...
namespace KERBALISM
{
	public class ResourceBroker : IEquatable<ResourceBroker>
	{
		...
		public static ResourceBroker Depressurization = GetOrCreate("Depressurization", BrokerCategory.VesselSystem, "Hab depressurization");
		public static ResourceBroker Deployment = GetOrCreate("Deployment", BrokerCategory.VesselSystem, "Deployment");
