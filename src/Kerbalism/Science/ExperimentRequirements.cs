...
namespace KERBALISM
{
	public class ExperimentRequirements
	{
		...
		public static string ReqName(Require req)
		{
			switch (req)
			{
				case Require.OrbitMinInclination:      return Localizer.Format("#KERBALISM_ExperimentReq_OrbitMinInclination");//"Min. inclination "
				case Require.OrbitMaxInclination:      return Localizer.Format("#KERBALISM_ExperimentReq_OrbitMaxInclination");//"Max. inclination "
				case Require.OrbitMinEccentricity:     return Localizer.Format("#KERBALISM_ExperimentReq_OrbitMinEccentricity");//"Min. eccentricity "
				case Require.OrbitMaxEccentricity:     return Localizer.Format("#KERBALISM_ExperimentReq_OrbitMaxEccentricity");//"Max. eccentricity "
				case Require.OrbitMinArgOfPeriapsis:   return Localizer.Format("#KERBALISM_ExperimentReq_OrbitMinArgOfPeriapsis");//"Min. argument of Pe "
				case Require.OrbitMaxArgOfPeriapsis:   return Localizer.Format("#KERBALISM_ExperimentReq_OrbitMaxArgOfPeriapsis");//"Max. argument of Pe "
				case Require.TemperatureMin:           return Localizer.Format("#KERBALISM_ExperimentReq_TemperatureMin");//"Min. temperature "
				case Require.TemperatureMax:           return Localizer.Format("#KERBALISM_ExperimentReq_TemperatureMax");//"Max. temperature "
				case Require.AltitudeMin:              return Localizer.Format("#KERBALISM_ExperimentReq_AltitudeMin");//"Min. altitude "
				case Require.AltitudeMax:              return Localizer.Format("#KERBALISM_ExperimentReq_AltitudeMax");//"Max. altitude "
				case Require.RadiationMin:             return Localizer.Format("#KERBALISM_ExperimentReq_RadiationMin");//"Min. radiation "
				case Require.RadiationMax:             return Localizer.Format("#KERBALISM_ExperimentReq_RadiationMax");//"Max. radiation "
				case Require.VolumePerCrewMin:         return Localizer.Format("#KERBALISM_ExperimentReq_VolumePerCrewMin");//"Min. vol./crew "
				case Require.VolumePerCrewMax:         return Localizer.Format("#KERBALISM_ExperimentReq_VolumePerCrewMax");//"Max. vol./crew "
				case Require.SunAngleMin:              return Localizer.Format("#KERBALISM_ExperimentReq_SunAngleMin");//"Min sun-surface angle"
				case Require.SunAngleMax:              return Localizer.Format("#KERBALISM_ExperimentReq_SunAngleMax");//"Max sun-surface angle"
				case Require.SurfaceSpeedMin:          return Localizer.Format("#KERBALISM_ExperimentReq_SurfaceSpeedMin");//"Min. surface speed "
				case Require.SurfaceSpeedMax:          return Localizer.Format("#KERBALISM_ExperimentReq_SurfaceSpeedMax");//"Max. surface speed "
				case Require.VerticalSpeedMin:         return Localizer.Format("#KERBALISM_ExperimentReq_VerticalSpeedMin");//"Min. vertical speed "
				case Require.VerticalSpeedMax:         return Localizer.Format("#KERBALISM_ExperimentReq_VerticalSpeedMax");//"Max. vertical speed "
				case Require.SpeedMin:                 return Localizer.Format("#KERBALISM_ExperimentReq_SpeedMin");//"Min. speed "
				case Require.SpeedMax:                 return Localizer.Format("#KERBALISM_ExperimentReq_SpeedMax");//"Max. speed "
				case Require.DynamicPressureMin:       return Localizer.Format("#KERBALISM_ExperimentReq_DynamicPressureMin");//"Min dynamic pressure"
				case Require.DynamicPressureMax:       return Localizer.Format("#KERBALISM_ExperimentReq_DynamicPressureMax");//"Max dynamic pressure"
				case Require.StaticPressureMin:        return  Localizer.Format("#KERBALISM_ExperimentReq_StaticPressureMin");//"Min. pressure "
				case Require.StaticPressureMax:        return Localizer.Format("#KERBALISM_ExperimentReq_StaticPressureMax");//"Max. pressure "
				case Require.AtmDensityMin:            return Localizer.Format("#KERBALISM_ExperimentReq_AtmDensityMin");//"Min. atm. density "
				case Require.AtmDensityMax:            return Localizer.Format("#KERBALISM_ExperimentReq_AtmDensityMax");//"Max. atm. density "
				case Require.AltAboveGroundMin:        return Localizer.Format("#KERBALISM_ExperimentReq_AltAboveGroundMin");//"Min ground altitude"
				case Require.AltAboveGroundMax:        return Localizer.Format("#KERBALISM_ExperimentReq_AltAboveGroundMax");//"Max ground altitude"
				case Require.MaxAsteroidDistance:      return Localizer.Format("#KERBALISM_ExperimentReq_MaxAsteroidDistance");//"Max asteroid distance"
				case Require.AtmosphereAltMin:         return Localizer.Format("#KERBALISM_ExperimentReq_AtmosphereAltMin");//"Min atmosphere altitude "
				case Require.AtmosphereAltMax:         return Localizer.Format("#KERBALISM_ExperimentReq_AtmosphereAltMax");//"Max atmosphere altitude "
				case Require.CrewMin:                  return Localizer.Format("#KERBALISM_ExperimentReq_CrewMin");//"Min. crew "
				case Require.CrewMax:                  return Localizer.Format("#KERBALISM_ExperimentReq_CrewMax");//"Max. crew "
				case Require.CrewCapacityMin:          return Localizer.Format("#KERBALISM_ExperimentReq_CrewCapacityMin");//"Min. crew capacity "
				case Require.CrewCapacityMax:          return Localizer.Format("#KERBALISM_ExperimentReq_CrewCapacityMax");//"Max. crew capacity "
				case Require.AstronautComplexLevelMin: return Localizer.Format("#KERBALISM_ExperimentReq_AstronautComplexLevelMin");//"Astronaut Complex min level "
				case Require.AstronautComplexLevelMax: return Localizer.Format("#KERBALISM_ExperimentReq_AstronautComplexLevelMin");//"Astronaut Complex max level "
				case Require.TrackingStationLevelMin:  return Localizer.Format("#KERBALISM_ExperimentReq_TrackingStationLevelMin");//"Tracking Station min level "
				case Require.TrackingStationLevelMax:  return Localizer.Format("#KERBALISM_ExperimentReq_TrackingStationLevelMax");//"Tracking Station max level "
				case Require.MissionControlLevelMin:   return Localizer.Format("#KERBALISM_ExperimentReq_MissionControlLevelMin");//"Mission Control min level "
				case Require.MissionControlLevelMax:   return Localizer.Format("#KERBALISM_ExperimentReq_MissionControlLevelMax");//"Mission Control max level "
				case Require.AdministrationLevelMin:   return Localizer.Format("#KERBALISM_ExperimentReq_AdministrationLevelMin");//"Administration min level "
				case Require.AdministrationLevelMax:   return Localizer.Format("#KERBALISM_ExperimentReq_AdministrationLevelMax");//"Administration max level "
				case Require.Part:                                  return Localizer.Format("#KERBALISM_ExperimentReq_Part");//"Need part "
				case Require.Module:                   return  Localizer.Format("#KERBALISM_ExperimentReq_Module");//"Need module "
