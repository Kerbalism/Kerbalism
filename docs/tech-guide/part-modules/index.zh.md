...
Kerbalism 部件模块速查。完整字段说明仍以英文页为准；源码在 [`src/Kerbalism/Modules/`](https://github.com/Kerbalism/Kerbalism/tree/master/src/Kerbalism/Modules)。
...
完整索引请看 [英文 PartModules 页](index.md)（切到 English，或等回退）。
